...
export default function EmployeeModal({ closeModal, children }: ModalProps) {
  return (
    <div
    ...
    >
      <div className="relative w-[30%] h-[30%] rounded-2xl bg-floral text-black text-left shadow-xl transition-all">
        <div className="px-5 py-4 relative">
          ...
          <h2 className="text-center text-lg font-bold">Edit Data</h2>
