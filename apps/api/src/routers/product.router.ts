...
export class ProductRouter {
    ...
    private initialization(): void {
        ...
        this.router.post('/', this.authMiddleware.verifyToken, this.authMiddleware.checkAdmin, uploader('product', '/products').fields([{ name: 'image_hot', maxCount: 1 },{ name: 'image_iced', maxCount: 1 }]), this.productController.createProduct)
